      ...
      <div className="issues-grid">
        ...
        <aside className="issues-side">
          ...
          <div className="issue-side-card">
            ...
            <button type="button" className="issue-quick-btn" onClick={openReportModal}>
              <span className="issue-quick-btn-top">
                <span className="issue-quick-btn-label">요약 리포트 생성</span>
                <span className="issue-quick-btn-state">AI 생성</span>
              </span>
              <span className="issue-quick-btn-desc">선택 이슈를 기준으로 자동 리포트 초안을 생성합니다.</span>
            </button>
          </div>
